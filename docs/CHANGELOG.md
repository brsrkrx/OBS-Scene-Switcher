...
- 🔔 **Beta Updates** - Option to opt in to pre-release/beta updates from within the editor
- 🔗 **Affiliate links** added to README and editor About page

### Fixed
- 🔌 Updated Joystick.tv WebSocket API address to `wss://api.joystick.tv/cable`
